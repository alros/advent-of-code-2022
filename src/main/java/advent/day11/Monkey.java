...
public class Monkey {
	...
	private final List<Integer> worryLevel;
	...
	public Monkey(int id, List<Integer> worryLevel, String operation, int divisible, int monkeyTrue, int monkeyFalse) {
		this.id = id;
	...
	public List<Integer> getWorryLevel() {
		return worryLevel;
	}
	...
	public String toString() {
		return "Monkey [id=" + id + ", worryLevel=" + worryLevel + "]";
	}
