...
public class Day10 {
	...
	public List<Integer> getInterestingCycles(BufferedReader bufReader, PrintStream out) throws IOException {
	...
	public List<Integer> calculateX(BufferedReader bufReader, PrintStream out) throws IOException {
		...
		for (String line = bufReader.readLine(); line != null; line = bufReader.readLine()) {
			...
			cycle++;
			instructions.add(new Instruction(InstructionType.valueOf(split[0]),
	...
	private int loop(List<Instruction> instructions, List<Integer> valuesOfX, int x, int cycle, PrintStream out) {
